...
<p align="center">
  <img src="https://img.shields.io/badge/Codex_Terminal-0F172A?style=flat&logo=openai&logoColor=white" alt="Codex Terminal">
...
Codex Career Ops v1 turns the original Career-Ops system into a Codex-first job search command center. Instead of manually tracking applications in a spreadsheet, you get an AI-powered pipeline that:
...
This fork is agentic: Codex Terminal navigates career pages with Playwright, evaluates fit by reasoning about your CV vs the job description, and adapts your resume per listing.
...
| **Batch Processing** | Parallel evaluation flow retained from Career-Ops, with Codex-first migration planned |
...
codex   # Open Codex Terminal in this directory
...
```
codex_career_ops_v1/
├── CODEX.md                     # Primary Codex instructions
├── CLAUDE.md                    # Inherited Career-Ops rules kept for compatibility
...
![Codex Terminal](https://img.shields.io/badge/Codex_Terminal-0F172A?style=flat&logo=openai&logoColor=white)
![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat&logo=node.js&logoColor=white)
![Playwright](https://img.shields.io/badge/Playwright-2EAD33?style=flat&logo=playwright&logoColor=white)
![Go](https://img.shields.io/badge/Go-00ADD8?style=flat&logo=go&logoColor=white)
![Bubble Tea](https://img.shields.io/badge/Bubble_Tea-FF75B5?style=flat&logo=go&logoColor=white)

- **Agent**: Codex Terminal with Career-Ops modes and docs
